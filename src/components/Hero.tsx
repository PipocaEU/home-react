...
export const Hero = ({ imageSrc, imageAlt = "Imagem hero" }: HeroProps) => {
  return (
    ...
    >
      <div
        className="bg-[#3F1F56] bg-opacity-80  md:w-[350px] lg:w-[500px] 2xl:w-[648px] lg:m-[-60px]  px-5 py-7 sm:px-5 sm:py-14 rounded-2xl "
        id="hero-content"
      >
        <h2
          className="text-2xl font-medium font-roboto lg:text-4xl sm:text-4xl"
          id="hero-title"
        >
        ...
        <h3
          className="pt-4 font-roboto lg:text-3xl/none sm:text-2xl/snug text-xl/snug"
          id="hero-subtitle"
        >
